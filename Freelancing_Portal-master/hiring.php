...
<div class="row container-fluid mx-0 px-0">
    ...
    <?php
            ...
            $query = "SELECT * FROM freelancers ORDER BY rating DESC";
    ...
    <div class="card-section col-md-4 my-4 px-0" id="card-section">
        <div class="card">
            ...
            <div class="card-part card-center">
                <span class="price"><?php echo $row['rating']; ?></span>
                <span class="price">⭐</span>
            </div>
            <div class="card-part card-bottom">
                <ul class="list-options">
                    <li>
                        <a href="<?php echo $row['drive_link'] ?>" target="_blank" class="btn btn-primary px-2">View
                            Resume</a>
                    </li>
                </ul>
                <ul class="list-options mt-2">
                    <li><b class="text-light">Designation / Job</b> : <?php echo $row['job']; ?></li>
                </ul>
                <ul class="list-options">
                    <li><b class="text-light">Skills</b> : <?php echo $row['skills']; ?></li>
                </ul>

                <form action="<?php echo $base_url;?>/code.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <button type="submit" name="employer_hire" class="btn-signup" style="cursor:pointer;">
                        Hire Now</button></a>
                </form>
            </div>
        </div>
