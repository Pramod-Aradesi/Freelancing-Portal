    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item <?= (basename($_SERVER['PHP_SELF']) == "freelancers.php") ? "nav-active" : ""; ?>">
                <a class="nav-link" href=" <?php echo $base_url ?>/freelancers.php">Hired Freelancers</a>
            </li>
            <li class="nav-item <?= (basename($_SERVER['PHP_SELF']) == "applied_jobs.php") ? "nav-active" : ""; ?>">
                <a class="nav-link" href=" <?php echo $base_url ?>/applied_jobs.php">Applied Freelancers</a>
            </li>
            <li class="nav-item <?= (basename($_SERVER['PHP_SELF']) == "contact-us.php") ? "nav-active" : ""; ?>">
                <a class="text-capitalize nav-name nav-link text-primary" href="#">| &nbsp;Name : <span
                        class="text-capitalize"><?php echo $_SESSION['employers_name']; ?></span></a>
            </li>
            <li>
