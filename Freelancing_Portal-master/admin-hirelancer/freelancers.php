                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <?php if( $row['status'] == '1')
                                {
                                    ...
                                    echo "</td>";
                                    echo '<td class="text-center"><button type="submit" name="freelancer_deactivate" class="btn btn-danger">DEACTIVATE</button></td>';
                                }
                                else{
                                    echo "<p class='text-danger font-weight-bold'>NOT YET ACTIVATED / DEACTIVATED </p>";
                                    echo "</td>";
                                    echo'<td class="text-center"><button type="submit" name="freelancer_activate" class="btn btn-success">ACTIVATE</button></td>';
                                }
                                ?>
                                </form>
